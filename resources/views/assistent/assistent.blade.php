...
<style scoped>
    ...
    .chat-header span {
        flex-grow: 1;
        /* Permite que el <span> ocupe todo el espacio disponible */
    }

    .chat-header button {
        margin-left: 10px;
        /* Agrega un margen izquierdo para separar el botón del <span> */
    }
...
<div id="chat-body">
    <div class="floating-container d-flex justify-content-center align-items-center" :style="containerStyle"
        v-if="!chatOpen">
        <button class="floating-button" @click="handleButtonClick">
            <img src="{{ asset('storage/images/sai.png') }}" style="width: 100%; height: 100%; border-radius: 50%;"
                alt="Logo de nuestro asistente virtual" srcset="">
        </button>
    </div>

    <div v-if="chatOpen" class="chat-container">
        <div class="chat-header">
            <span>{{ $assistant->nombre }}</span>
            <button class="close-button" @click="closeChat">×</button>
        </div>

        <div class="chat-messages">
            <div v-for="message in messages" class="chat-message" :key="message.id"
            ...
            addMessage(message) {
                ...
                this.$nextTick(() => {
                    ...
                    if (chatBody) {
                        ...
                        console.log("El elemento es nulo o no se encontró");
                    }
                });
            },
            handleScroll() {
