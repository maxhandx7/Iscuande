...
@section('title', 'Gestión de reporte de cita')
@section('styles')
@endsection
@section('options')
@endsection
        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-custom">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Reporte de cita</li>
                </ol>
            </nav>
        </div>
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title">Gestión de reporte de cita</h4>
                        </div>
                        {!! Form::open(['route' => 'exportar.cita', 'method' => 'POST']) !!}
